package com.evan.rabbitmq.task.parser;
...
import com.evan.rabbitmq.task.autoconfigure.JobZookeeperProperties;
import com.evan.rabbitmq.task.enums.ElasticJobTypeEnum;
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        try {
            ...
            for (Object confBean : beanMap.values()) {
                ...
                // 获取接口类型 用于判断是什么类型的任务（这里如果是生产环境要进行完善，循环判断多个接口）
                ...
                // 利用BeanDefinitionBuilder，创建一个Spring的beanDefinition
